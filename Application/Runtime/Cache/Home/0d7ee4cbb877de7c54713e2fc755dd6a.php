...
<link href="/Template/pc/soubao/Static/css/tsinformation.css" rel="stylesheet" type="text/css">
</head>
...
<?php if(isset($message)) {?>
   <!-- 处理成功 -->
   <div class="box-ts">
    	<i><img src="/Template/pc/soubao/Static/images/success_ts.png"></i>         
        <ul>
        	<li><h3> <?php echo($message); ?><h3></li>
                <li><a href="javascript:void(0);">页面自动 <a id="href" href="<?php echo($jumpUrl); ?>">跳转</a> 等待时间： <b id="wait"><?php echo($waitSecond); ?></b></a></li>
                <li>
...
<?php }else{?>        
     <!-- 处理失败 -->
     <div class="box-ts">
    	<i><img src="/Template/pc/soubao/Static/images/error_ts.png"></i>
        <ul>
