...
<title>支付页面-<?php echo ($tpshop_config['shop_info_store_title']); ?></title>
...
.fail-fasu{float:left; width:200px; height:180px; padding-top:100px; background:url(/Template/pc/soubao/Static/images/icon-pay.png) 50px 0 no-repeat; text-align:center}
.success-fasu{float:right; width:200px; height:180px; padding-top:100px; background:url(/Template/pc/soubao/Static/images/icon-pay.png) -220px 0 no-repeat; text-align:center}
    	...
    	<div class="wihe-ee">
            ...
            <div class="fail-success">
                ...
                <div class="fail-I-success" style="float:left">
                	<!--<img src="/Template/pc/soubao/Static/images/qrcode_vmall_app01.png" width="110" height="110"/>-->
                    <?php echo ($code_str); ?>
                </div>
