...
<div id="pageContent">
  <div class="fn-mall">
        ...
        <div class="feture-cates">
          ...
          <?php $pid =50;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->getField("position_id,position_name,ad_width,ad_height");$result = D("ad")->where("pid=$pid  and enabled = 1 and start_time < 1501135200 and end_time > 1501135200 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select(); if(!in_array($pid,array_keys($ad_position)) && $pid) { M("ad_position")->add(array( "position_id"=>$pid, "position_name"=>CONTROLLER_NAME."页面自动增加广告位 $pid ", "is_open"=>1, "position_desc"=>CONTROLLER_NAME."页面", )); delFile(RUNTIME_PATH); } $c = 1- count($result); if($c > 0 && $_GET[edit_ad]) { for($i = 0; $i < $c; $i++) { $result[] = array( "ad_code" => "/Public/images/not_adv.jpg", "ad_link" => "/index.php?m=Admin&c=Ad&a=ad&pid=$pid", "title" =>"暂无广告图片", "not_adv" => 1, "target" => 0, ); } } foreach($result as $key=>$v): $v[position] = $ad_position[$v[pid]]; if($_GET[edit_ad] && $v[not_adv] == 0 ) { $v[style] = "filter:alpha(opacity=50); -moz-opacity:0.5; -khtml-opacity: 0.5; opacity: 0.5"; $v[ad_link] = "/index.php?m=Admin&c=Ad&a=ad&act=edit&ad_id=$v[ad_id]"; $v[title] = $ad_position[$v[pid]][position_name]."===".$v[ad_name]; $v[target] = 0; } ?><li class="item">
               <a href="<?php echo ($v["ad_link"]); ?>" <?php if($v['target'] == 1): ?>target="_blank"<?php endif; ?>>
            	   <img title="<?php echo ($v[title]); ?>" style="<?php echo ($v[style]); ?>" data-original="<?php echo ($v[ad_code]); ?>" class="img100 prod" src="<?php echo ($v[ad_code]); ?>">
               </a>
            </li><?php endforeach; ?>          
          ...
          <?php $pid =55;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->getField("position_id,position_name,ad_width,ad_height");$result = D("ad")->where("pid=$pid  and enabled = 1 and start_time < 1501135200 and end_time > 1501135200 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select(); if(!in_array($pid,array_keys($ad_position)) && $pid) { M("ad_position")->add(array( "position_id"=>$pid, "position_name"=>CONTROLLER_NAME."页面自动增加广告位 $pid ", "is_open"=>1, "position_desc"=>CONTROLLER_NAME."页面", )); delFile(RUNTIME_PATH); } $c = 1- count($result); if($c > 0 && $_GET[edit_ad]) { for($i = 0; $i < $c; $i++) { $result[] = array( "ad_code" => "/Public/images/not_adv.jpg", "ad_link" => "/index.php?m=Admin&c=Ad&a=ad&pid=$pid", "title" =>"暂无广告图片", "not_adv" => 1, "target" => 0, ); } } foreach($result as $key=>$v): $v[position] = $ad_position[$v[pid]]; if($_GET[edit_ad] && $v[not_adv] == 0 ) { $v[style] = "filter:alpha(opacity=50); -moz-opacity:0.5; -khtml-opacity: 0.5; opacity: 0.5"; $v[ad_link] = "/index.php?m=Admin&c=Ad&a=ad&act=edit&ad_id=$v[ad_id]"; $v[title] = $ad_position[$v[pid]][position_name]."===".$v[ad_name]; $v[target] = 0; } ?><li class="item">
               <a href="<?php echo ($v["ad_link"]); ?>" <?php if($v['target'] == 1): ?>target="_blank"<?php endif; ?>>
            	   <img title="<?php echo ($v[title]); ?>" style="<?php echo ($v[style]); ?>" data-original="<?php echo ($v[ad_code]); ?>" class="img100 prod" src="<?php echo ($v[ad_code]); ?>">
               </a>
            </li><?php endforeach; ?>                                        
          ...
          <div class="cates-center" fnp="slide">
            <ul class="ui-switchable-content" data-role="content">
              <li class="panel panel-action">
	              <?php $pid =56;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->getField("position_id,position_name,ad_width,ad_height");$result = D("ad")->where("pid=$pid  and enabled = 1 and start_time < 1501135200 and end_time > 1501135200 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select(); if(!in_array($pid,array_keys($ad_position)) && $pid) { M("ad_position")->add(array( "position_id"=>$pid, "position_name"=>CONTROLLER_NAME."页面自动增加广告位 $pid ", "is_open"=>1, "position_desc"=>CONTROLLER_NAME."页面", )); delFile(RUNTIME_PATH); } $c = 1- count($result); if($c > 0 && $_GET[edit_ad]) { for($i = 0; $i < $c; $i++) { $result[] = array( "ad_code" => "/Public/images/not_adv.jpg", "ad_link" => "/index.php?m=Admin&c=Ad&a=ad&pid=$pid", "title" =>"暂无广告图片", "not_adv" => 1, "target" => 0, ); } } foreach($result as $key=>$v): $v[position] = $ad_position[$v[pid]]; if($_GET[edit_ad] && $v[not_adv] == 0 ) { $v[style] = "filter:alpha(opacity=50); -moz-opacity:0.5; -khtml-opacity: 0.5; opacity: 0.5"; $v[ad_link] = "/index.php?m=Admin&c=Ad&a=ad&act=edit&ad_id=$v[ad_id]"; $v[title] = $ad_position[$v[pid]][position_name]."===".$v[ad_name]; $v[target] = 0; } ?><div class="item">
                       <a href="<?php echo ($v["ad_link"]); ?>" <?php if($v['target'] == 1): ?>target="_blank"<?php endif; ?>>
                           <img title="<?php echo ($v[title]); ?>" style="<?php echo ($v[style]); ?>" data-original="<?php echo ($v[ad_code]); ?>" class="img100 prod" src="<?php echo ($v[ad_code]); ?>" />
                       </a>
                    </div><?php endforeach; ?>  
	              <?php $pid =57;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->getField("position_id,position_name,ad_width,ad_height");$result = D("ad")->where("pid=$pid  and enabled = 1 and start_time < 1501135200 and end_time > 1501135200 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select(); if(!in_array($pid,array_keys($ad_position)) && $pid) { M("ad_position")->add(array( "position_id"=>$pid, "position_name"=>CONTROLLER_NAME."页面自动增加广告位 $pid ", "is_open"=>1, "position_desc"=>CONTROLLER_NAME."页面", )); delFile(RUNTIME_PATH); } $c = 1- count($result); if($c > 0 && $_GET[edit_ad]) { for($i = 0; $i < $c; $i++) { $result[] = array( "ad_code" => "/Public/images/not_adv.jpg", "ad_link" => "/index.php?m=Admin&c=Ad&a=ad&pid=$pid", "title" =>"暂无广告图片", "not_adv" => 1, "target" => 0, ); } } foreach($result as $key=>$v): $v[position] = $ad_position[$v[pid]]; if($_GET[edit_ad] && $v[not_adv] == 0 ) { $v[style] = "filter:alpha(opacity=50); -moz-opacity:0.5; -khtml-opacity: 0.5; opacity: 0.5"; $v[ad_link] = "/index.php?m=Admin&c=Ad&a=ad&act=edit&ad_id=$v[ad_id]"; $v[title] = $ad_position[$v[pid]][position_name]."===".$v[ad_name]; $v[target] = 0; } ?><div class="item">
                       <a href="<?php echo ($v["ad_link"]); ?>" <?php if($v['target'] == 1): ?>target="_blank"<?php endif; ?>>
                           <img title="<?php echo ($v[title]); ?>" style="<?php echo ($v[style]); ?>" data-original="<?php echo ($v[ad_code]); ?>" class="img100 prod" src="<?php echo ($v[ad_code]); ?>" />
                       </a>
                    </div><?php endforeach; ?>  
              ...
              <li class="panel">
	              <?php $pid =58;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->getField("position_id,position_name,ad_width,ad_height");$result = D("ad")->where("pid=$pid  and enabled = 1 and start_time < 1501135200 and end_time > 1501135200 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select(); if(!in_array($pid,array_keys($ad_position)) && $pid) { M("ad_position")->add(array( "position_id"=>$pid, "position_name"=>CONTROLLER_NAME."页面自动增加广告位 $pid ", "is_open"=>1, "position_desc"=>CONTROLLER_NAME."页面", )); delFile(RUNTIME_PATH); } $c = 1- count($result); if($c > 0 && $_GET[edit_ad]) { for($i = 0; $i < $c; $i++) { $result[] = array( "ad_code" => "/Public/images/not_adv.jpg", "ad_link" => "/index.php?m=Admin&c=Ad&a=ad&pid=$pid", "title" =>"暂无广告图片", "not_adv" => 1, "target" => 0, ); } } foreach($result as $key=>$v): $v[position] = $ad_position[$v[pid]]; if($_GET[edit_ad] && $v[not_adv] == 0 ) { $v[style] = "filter:alpha(opacity=50); -moz-opacity:0.5; -khtml-opacity: 0.5; opacity: 0.5"; $v[ad_link] = "/index.php?m=Admin&c=Ad&a=ad&act=edit&ad_id=$v[ad_id]"; $v[title] = $ad_position[$v[pid]][position_name]."===".$v[ad_name]; $v[target] = 0; } ?><div class="item">
                       <a href="<?php echo ($v["ad_link"]); ?>" <?php if($v['target'] == 1): ?>target="_blank"<?php endif; ?>>
                           <img title="<?php echo ($v[title]); ?>" style="<?php echo ($v[style]); ?>" data-original="<?php echo ($v[ad_code]); ?>" class="img100 prod" src="<?php echo ($v[ad_code]); ?>" />
                       </a>
                    </div><?php endforeach; ?>  
	              <?php $pid =59;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->getField("position_id,position_name,ad_width,ad_height");$result = D("ad")->where("pid=$pid  and enabled = 1 and start_time < 1501135200 and end_time > 1501135200 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select(); if(!in_array($pid,array_keys($ad_position)) && $pid) { M("ad_position")->add(array( "position_id"=>$pid, "position_name"=>CONTROLLER_NAME."页面自动增加广告位 $pid ", "is_open"=>1, "position_desc"=>CONTROLLER_NAME."页面", )); delFile(RUNTIME_PATH); } $c = 1- count($result); if($c > 0 && $_GET[edit_ad]) { for($i = 0; $i < $c; $i++) { $result[] = array( "ad_code" => "/Public/images/not_adv.jpg", "ad_link" => "/index.php?m=Admin&c=Ad&a=ad&pid=$pid", "title" =>"暂无广告图片", "not_adv" => 1, "target" => 0, ); } } foreach($result as $key=>$v): $v[position] = $ad_position[$v[pid]]; if($_GET[edit_ad] && $v[not_adv] == 0 ) { $v[style] = "filter:alpha(opacity=50); -moz-opacity:0.5; -khtml-opacity: 0.5; opacity: 0.5"; $v[ad_link] = "/index.php?m=Admin&c=Ad&a=ad&act=edit&ad_id=$v[ad_id]"; $v[title] = $ad_position[$v[pid]][position_name]."===".$v[ad_name]; $v[target] = 0; } ?><div class="item">
                       <a href="<?php echo ($v["ad_link"]); ?>" <?php if($v['target'] == 1): ?>target="_blank"<?php endif; ?>>
                           <img title="<?php echo ($v[title]); ?>" style="<?php echo ($v[style]); ?>" data-original="<?php echo ($v[ad_code]); ?>" class="img100 prod" src="<?php echo ($v[ad_code]); ?>" />
                       </a>
                    </div><?php endforeach; ?>                
			...
			<ul class="slide-nav ui-switchable-nav" data-role="nav">
				<li class="ui-switchable-trigger ui-switchable-active"><span>1</span></li>
          ...
          <ul class="cates-right">
	              <?php $pid =60;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->getField("position_id,position_name,ad_width,ad_height");$result = D("ad")->where("pid=$pid  and enabled = 1 and start_time < 1501135200 and end_time > 1501135200 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select(); if(!in_array($pid,array_keys($ad_position)) && $pid) { M("ad_position")->add(array( "position_id"=>$pid, "position_name"=>CONTROLLER_NAME."页面自动增加广告位 $pid ", "is_open"=>1, "position_desc"=>CONTROLLER_NAME."页面", )); delFile(RUNTIME_PATH); } $c = 1- count($result); if($c > 0 && $_GET[edit_ad]) { for($i = 0; $i < $c; $i++) { $result[] = array( "ad_code" => "/Public/images/not_adv.jpg", "ad_link" => "/index.php?m=Admin&c=Ad&a=ad&pid=$pid", "title" =>"暂无广告图片", "not_adv" => 1, "target" => 0, ); } } foreach($result as $key=>$v): $v[position] = $ad_position[$v[pid]]; if($_GET[edit_ad] && $v[not_adv] == 0 ) { $v[style] = "filter:alpha(opacity=50); -moz-opacity:0.5; -khtml-opacity: 0.5; opacity: 0.5"; $v[ad_link] = "/index.php?m=Admin&c=Ad&a=ad&act=edit&ad_id=$v[ad_id]"; $v[title] = $ad_position[$v[pid]][position_name]."===".$v[ad_name]; $v[target] = 0; } ?><div class="item">
                       <a href="<?php echo ($v["ad_link"]); ?>" <?php if($v['target'] == 1): ?>target="_blank"<?php endif; ?>>
                           <img title="<?php echo ($v[title]); ?>" style="<?php echo ($v[style]); ?>" data-original="<?php echo ($v[ad_code]); ?>" class="img100 prod" src="<?php echo ($v[ad_code]); ?>" />
                       </a>
                    </div><?php endforeach; ?>
	              <?php $pid =61;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->getField("position_id,position_name,ad_width,ad_height");$result = D("ad")->where("pid=$pid  and enabled = 1 and start_time < 1501135200 and end_time > 1501135200 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select(); if(!in_array($pid,array_keys($ad_position)) && $pid) { M("ad_position")->add(array( "position_id"=>$pid, "position_name"=>CONTROLLER_NAME."页面自动增加广告位 $pid ", "is_open"=>1, "position_desc"=>CONTROLLER_NAME."页面", )); delFile(RUNTIME_PATH); } $c = 1- count($result); if($c > 0 && $_GET[edit_ad]) { for($i = 0; $i < $c; $i++) { $result[] = array( "ad_code" => "/Public/images/not_adv.jpg", "ad_link" => "/index.php?m=Admin&c=Ad&a=ad&pid=$pid", "title" =>"暂无广告图片", "not_adv" => 1, "target" => 0, ); } } foreach($result as $key=>$v): $v[position] = $ad_position[$v[pid]]; if($_GET[edit_ad] && $v[not_adv] == 0 ) { $v[style] = "filter:alpha(opacity=50); -moz-opacity:0.5; -khtml-opacity: 0.5; opacity: 0.5"; $v[ad_link] = "/index.php?m=Admin&c=Ad&a=ad&act=edit&ad_id=$v[ad_id]"; $v[title] = $ad_position[$v[pid]][position_name]."===".$v[ad_name]; $v[target] = 0; } ?><div class="item">
                       <a href="<?php echo ($v["ad_link"]); ?>" <?php if($v['target'] == 1): ?>target="_blank"<?php endif; ?>>
                           <img title="<?php echo ($v[title]); ?>" style="<?php echo ($v[style]); ?>" data-original="<?php echo ($v[ad_code]); ?>" class="img100 prod" src="<?php echo ($v[ad_code]); ?>" />
                       </a>
                    </div><?php endforeach; ?>                  
    ...
    <?php if(is_array($cateList)): foreach($cateList as $k=>$vo): ?><div class="module module-list" moduleId="" parentModuleId="">
      <div class="layout floor floor-0<?php echo ($k+1); ?> container mt30" data-floor="<?php echo ($k+1); ?>">
        <div class="floor-wrapper">
          <div class="floor-left">
            ...
            <div class="slide eidtModule" moduleId="1081777_leftBottomSlide" fnp="slide" k="<?php echo ($k); ?>">
              <div class="slide-container">
                <ul data-role="content">
                <?php $pid =70+$k;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->getField("position_id,position_name,ad_width,ad_height");$result = D("ad")->where("pid=$pid  and enabled = 1 and start_time < 1501135200 and end_time > 1501135200 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("4")->select(); if(!in_array($pid,array_keys($ad_position)) && $pid) { M("ad_position")->add(array( "position_id"=>$pid, "position_name"=>CONTROLLER_NAME."页面自动增加广告位 $pid ", "is_open"=>1, "position_desc"=>CONTROLLER_NAME."页面", )); delFile(RUNTIME_PATH); } $c = 4- count($result); if($c > 0 && $_GET[edit_ad]) { for($i = 0; $i < $c; $i++) { $result[] = array( "ad_code" => "/Public/images/not_adv.jpg", "ad_link" => "/index.php?m=Admin&c=Ad&a=ad&pid=$pid", "title" =>"暂无广告图片", "not_adv" => 1, "target" => 0, ); } } foreach($result as $kk=>$v): $v[position] = $ad_position[$v[pid]]; if($_GET[edit_ad] && $v[not_adv] == 0 ) { $v[style] = "filter:alpha(opacity=50); -moz-opacity:0.5; -khtml-opacity: 0.5; opacity: 0.5"; $v[ad_link] = "/index.php?m=Admin&c=Ad&a=ad&act=edit&ad_id=$v[ad_id]"; $v[title] = $ad_position[$v[pid]][position_name]."===".$v[ad_name]; $v[target] = 0; } ?><li class="panel <?php if($kk == 0): ?>panel-action<?php endif; ?>">                   
                   <a href="<?php echo ($v["ad_link"]); ?>" <?php if($v['target'] == 1): ?>target="_blank"<?php endif; ?>>
              ...
              <ul class="slide-nav ui-switchable-nav" data-role="nav">
	              ...
	              <li class="ui-switchable-trigger"><span>4</span></li>
              </ul>
            </div>
          </div>
        ...
        <div class="banner-img-list eidtModule" moduleId="">
        	<?php $br = '0'; ?>
        	<?php if(is_array($brand_list)): foreach($brand_list as $k2=>$vv): if(($vv[cat_id1] == $vo[id]) AND ($br++ < 9)): ?><a href="<?php echo U('Goods/goodsList',array('brand_id'=>$vv[id]));?>" target ="_blank" class="<?php if($br < 9): ?>item<?php endif; ?> item0<?php echo ($k2); ?>">
      ...
      <div class="layout boutique container mt30">
        ...
        <div class="layout-bd">
          <div class="boutique-left">
          	<?php
 $md5_key = md5("select * from __PREFIX__goods where is_new=1 order by sort limit 7"); $result_name = $sql_result_v = S("sql_".$md5_key); if(empty($sql_result_v)) { $Model = new \Think\Model(); $result_name = $sql_result_v = $Model->query("select * from __PREFIX__goods where is_new=1 order by sort limit 7"); S("sql_".$md5_key,$sql_result_v,1); } foreach($sql_result_v as $k=>$v): ?><div class="item <?php if($k == 0): ?>item-big<?php else: ?>item-small<?php endif; ?> ">
...
var speed2=5000;
		  $(function(){
			...
			$(".cates-center .ui-switchable-trigger").mouseenter(function(){
				triggerOnTop(this);
			});
			$(".module-list .ui-switchable-trigger").mouseenter(function(){
				triggerOn(this);
			});
			spide();
			$(".module-list .slide").mouseover(function(){
				var _ind=$(this).attr("k");
				
				clearInterval(timer[_ind]);
			});
			$(".cates-center").mouseover(function(){
				clearInterval(atime);
			});
			$(".cates-center").mouseout(function(){
				atime=setInterval("autoF()",speed2);
			});
			$(".module-list .slide").mouseout(function(){
				var _ind=$(this).attr("k");
				timer[_ind]=setInterval("autoP("+_ind+")",speed);
			});
			$(".cates-center .ctrl-prev").click(function(){
				var ind = $(".cates-center").find(".ui-switchable-active").index();
				if(ind==0){
					var obj=$(".cates-center").find(".ui-switchable-trigger")[3];
				}else{
					ind--;
					var obj=$(".cates-center").find(".ui-switchable-trigger")[ind];
				}
				triggerOnTop(obj);
			});
			$(".cates-center .ctrl-next").click(function(){
				autoF();
			});
		  })
		  ...
		  function spide(){
				...
				for(var i=0;i<$(".module-list").length;i++){
					timer[i]=setInterval("autoP("+i+")",speed);
				}
		  }
		  function autoF(){
				var ind = $(".cates-center").find(".ui-switchable-active").index();
				if(ind==3){
					var obj=$(".cates-center").find(".ui-switchable-trigger")[0];
				}else{
					ind++;
					var obj=$(".cates-center").find(".ui-switchable-trigger")[ind];
				}
		  ...
		  function autoP(index){
				
				var ind = $(".module-list:eq("+index+")").find(".ui-switchable-active").index();
				if(ind==3){
					var obj=$(".module-list:eq("+index+")").find(".ui-switchable-trigger")[0];
				}else{
					ind++;
					var obj=$(".module-list:eq("+index+")").find(".ui-switchable-trigger")[ind];
				}
				triggerOn(obj);
		  }
		  function triggerOnTop(obj){
				$(obj).parents(".cates-center").find(".panel").removeClass("panel-action");
				$(obj).parents(".cates-center").find(".panel:eq("+$(obj).index()+")").addClass("panel-action");
				$(obj).parent().find(".ui-switchable-trigger").removeClass("ui-switchable-active");
				$(obj).addClass("ui-switchable-active");
		  }
		  function triggerOn(obj){
				$(obj).parents(".slide").find(".panel").removeClass("panel-action");
				$(obj).parents(".slide").find(".panel:eq("+$(obj).index()+")").addClass("panel-action");
				$(obj).parent().find(".ui-switchable-trigger").removeClass("ui-switchable-active");
				$(obj).addClass("ui-switchable-active");
		  }
</script>
