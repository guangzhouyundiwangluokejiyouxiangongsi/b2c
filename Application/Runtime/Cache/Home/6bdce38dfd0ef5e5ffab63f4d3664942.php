...
<div class="wrapper mt10">
  <div class="ncs-main-container">
    ...
    <div class="ncs-goodslist-bar">
      <ul class="ncs-array">
      	<?php if(is_array($link_arr)): foreach($link_arr as $key=>$link): ?><li <?php if($link[key] == $keys): ?>class='selected'<?php endif; ?>>
      ...
      <ul>
      <?php if(is_array($goods_list)): foreach($goods_list as $key=>$vo): ?><li>
          <dl>
            ...
            <dd class="goods-name"><a href="<?php echo U('Goods/goodsInfo',array('id'=>$vo[goods_id]));?>" title="<?php echo (getSubstr($vo["goods_name"],0,30)); ?>" target="_blank"><?php echo (getSubstr($vo["goods_name"],0,20)); ?></a></dd>
