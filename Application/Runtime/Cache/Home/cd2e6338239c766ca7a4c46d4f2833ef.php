...
<title>搜索页面-<?php echo ($tpshop_config['shop_info_store_title']); ?></title>
...
<div id="warpper" class="clearfix">
	<div class="m-breadnav" id="path-new">
        <div class="item fl">
            <div class="fl"> 
                <span class="u-nav-title">搜索结果</span>
            </div>
        </div>        
        <div class="u-left-icon"><i class="z-arrow"></i></div>
        <div class="item fl">
            <div class="fl"> 
                <span class="u-nav-title selected"><?php echo ($filter_param['q']); ?></span>
            </div>
        </div>  
        <div class="u-left-icon"><i class="z-arrow"></i></div>
  ...
  <div class="cata_cart_left">
    <div class="m-cart-left">
        <p class="u-title"><a href="<?php echo U("/Home/Goods/search",array('q'=>$filter_param['q']),'');?>">全部分类</a></p>
        <ul id="category_list_rst">
        	<?php if(is_array($cateArr)): foreach($cateArr as $k=>$v): ?><li><a style="cursor:pointer;"  href="<?php echo ($v["href"]); ?>" class="text13 <?php if($_GET[id] == $v[id]): ?>selected<?php endif; ?>"><span><?php echo ($v["name"]); ?></span></a></li><?php endforeach; endif; ?>
        </ul>
         <div class="f-cate-more"><a href="javascript:;" onClick="$('#category_list_rst').toggleClass('more');$(this).children('i').toggleClass('checked');">收缩<i></i></a></div>
     </div>
  <!-- 推荐热卖-->
  ...
  <div class="searchbox">
    <div class="list clearfix">
      <ul class="left text12" id="order_ul">
        ...
        <li> <a class="col7ac  <?php if($_GET[sort] == ''): ?>main<?php endif; ?>" href="<?php echo urldecode(U("/Home/Goods/search",$filter_param,''));?>" style="cursor:pointer;"> 默认 </a> </li>
        <li> <a class="col7ac  <?php if($_GET[sort] == 'sales_sum'): ?>main<?php endif; ?>" href="<?php echo urldecode(U("/Home/Goods/search",array_merge($filter_param,array('sort'=>'sales_sum')),''));?>" style="cursor:pointer;"> 销量 </a> </li>
                
        <?php if($_GET['sort_asc'] == 'desc'): ?><li><a class="col7ac  <?php if($_GET[sort] == 'shop_price'): ?>main<?php endif; ?>" href="<?php echo urldecode(U("/Home/Goods/search",array_merge($filter_param,array('sort'=>'shop_price','sort_asc'=>'asc')),''));?>" style="cursor:pointer;">价格<span class="icon_s "></span></a></li>
        <?php else: ?>
        	<li><a class="col7ac  <?php if($_GET[sort] == 'shop_price'): ?>main<?php endif; ?>" href="<?php echo urldecode(U("/Home/Goods/search",array_merge($filter_param,array('sort'=>'shop_price','sort_asc'=>'desc')),''));?>" style="cursor:pointer;">价格<span class="icon_s "></span></a></li><?php endif; ?>    
                
        <li><a class="col7ac  <?php if($_GET[sort] == 'comment_count'): ?>main<?php endif; ?>" href="<?php echo urldecode(U("/Home/Goods/search",array_merge($filter_param,array('sort'=>'comment_count')),''));?>" style="cursor:pointer;">评论</a></li>
        <li><a class="col7ac  <?php if($_GET[sort] == 'is_new'): ?>main<?php endif; ?>"  href="<?php echo urldecode(U("/Home/Goods/search",array_merge($filter_param,array('sort'=>'is_new')),''));?>" style="cursor:pointer;">新品</a></li>
      </ul>
      <!-- Page -->
